...
export default function PanelComponent({
  ...
  const handleBringBackward = (id: string) => {
    actions.bringBackward(id);
  };
    ...
    <>
            ...
            <div className="relative" style={{ width: panel.width, height: panel.height }}>
              ...
              {panel.shape === "rectangle" ? (
                <div
                  ...
                  style={{
                    backgroundColor: panel.fillColor || (theme === "dark" ? "#374151" : "#ffffff"),
                    borderColor: panel.borderColor || (theme === "dark" ? "#6b7280" : "#d1d5db"),
                  }}
                />
              ) : panel.shape === "circle" ? (
                <div
                  className={`w-full h-full border-2 transition-colors duration-200 rounded-full`}
                  style={{
                    backgroundColor: panel.fillColor || (theme === "dark" ? "#374151" : "#ffffff"),
                    borderColor: panel.borderColor || (theme === "dark" ? "#6b7280" : "#d1d5db"),
                  }}
                ...
                <SVGShape
                  ...
                  width={panel.width}
                  height={panel.height}
                  fillColor={panel.fillColor || (theme === "dark" ? "#374151" : "#ffffff")}
              ...
              <div className="absolute inset-0 flex items-center justify-center p-4 z-10">
                <span
                  className={`text-l font-mono text-center max-w-full overflow-hidden`}
                  onDoubleClick={(e) => {
                    e.stopPropagation();
      ...
      {showEditPopup && (
        <EditPanelPopup
          ...
          onBringBackward={handleBringBackward}
        />
      )}
    </>
  );
